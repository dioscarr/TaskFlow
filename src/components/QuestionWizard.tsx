  ...
  return (
    <div className="w-full mb-4 animate-in fade-in slide-in-from-bottom-4 duration-300 z-30 relative">
      <div className="glass-card rounded-2xl overflow-hidden flex flex-col border border-sky-500/20 shadow-xl shadow-sky-900/5">
        {/* Header */}
        <div className="px-5 py-3 border-b border-white/5 bg-gradient-to-r from-sky-900/20 to-transparent flex items-center justify-between">
        ...
        <div className="p-5 max-h-[60vh] overflow-y-auto bg-black/40">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div key={idx} className="space-y-2">
                        ...
                        <div className="relative group">
                            <input
                                ...
                                className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-sky-500/50 focus:bg-white/[0.03] transition-all placeholder:text-white/10"
                ...
                <div className="pt-2">
                    <button
                        type="submit"
                        className="w-full bg-sky-600 hover:bg-sky-500 text-white font-medium py-3 rounded-xl shadow-lg shadow-sky-900/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group border-t border-white/10"
                    >
